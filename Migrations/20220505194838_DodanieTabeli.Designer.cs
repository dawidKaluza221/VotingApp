...
namespace VotingApp.Migrations
{
    ...
    [Migration("20220505194838_DodanieTabeli")]
    partial class DodanieTabeli
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VotingApp.Models.Answers", b =>
                {
                    ...
                    b.Property<int?>("CountingVotesIdCVotes")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CountingVotesIdCVotes");
            ...
            modelBuilder.Entity("VotingApp.Models.CountingVotes", b =>
                {
                    ...
                    b.ToTable("CountingVotes", (string)null);
                });
            ...
            modelBuilder.Entity("VotingApp.Models.Answers", b =>
                {
                    b.HasOne("VotingApp.Models.CountingVotes", "CountingVotes")
                        .WithMany("Answers")
                        .HasForeignKey("CountingVotesIdCVotes");
